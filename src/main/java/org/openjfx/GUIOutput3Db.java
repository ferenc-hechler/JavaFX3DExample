...
public class GUIOutput3Db extends Application {

	static GUIOutput3Db instance = null;
	...
	public GUIOutput3Db(String title, boolean useCachedNodes) {
		this.title = title;
...
//		currentScene.getChildren().add(box);
	...
	public static void main(String[] args) throws Exception {
		GUIOutput3Db output = new GUIOutput3Db("GUIOutput3D Test", true);
		output.smaller();
